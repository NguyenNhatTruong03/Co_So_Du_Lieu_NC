...
public class Transformation_Data implements ITransformation_Data {
	@Override
	public weather_weathers json_to_object(String location) {
		try {
			// Tạo URL của API
			/*
			 ...
			 */
			String apiUrl = "http://api.weatherapi.com/v1/current.json?" + "key=19f458c69f9f4a87ae1191400240305&q=";
			apiUrl = apiUrl + location + "&aqi=yes";
			...
			System.out.println(weather.getCurrent().getLast_update());
			// Đóng kết nối
